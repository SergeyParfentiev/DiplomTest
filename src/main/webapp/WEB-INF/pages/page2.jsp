<ul style="text-align:center">
    <li style="color:blue"><a href="#" onClick="showContent('/page1')">Page 1</a></li>
    <li style="color:green"><a href="#" onClick="showContent('/page2')">Page 2</a></li>
    <li style="color:cyan"><a href="#" onClick="showContent('/page3')">Page 3</a></li>
    <li style="color:red"><a href="#" onClick="showContent('/page4')">Page 4</a></li>
